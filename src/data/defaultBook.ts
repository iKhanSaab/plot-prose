  ...
  whiteboards: [
    {
      ...
      pins: [
        ...
        },
        {
          ...
          tags: [{ id: 't2', label: 'Plot', color: 'amber' }, { id: 't3', label: 'Key Scene', color: 'rose' }],
        ...
        },
        {
          ...
          tags: [{ id: 't5', label: 'Twist', color: 'lavender' }, { id: 't6', label: 'Key Scene', color: 'rose' }],
    ...
    },
    {
      ...
      pins: [
        ...
        },
        {
          ...
          tags: [{ id: 'tc2', label: 'Character', color: 'sage' }, { id: 'tc3', label: 'Villain', color: 'rose' }],
          connections: ['pin-c1'],
        },
      ],
    },
      ...
      drafts: [
        {
          id: 'draft-2a',
          name: 'First Draft',
          content: 'The letter arrived without a return address. Just her name, written in a hand she didn\'t recognize — elegant, deliberate, the ink slightly smudged as if the writer had been in a hurry.\n\nShe turned it over twice before opening it.',
